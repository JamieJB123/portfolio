...
export default function CV() {
    return (
        <a href="/CV.pdf" download className="download-cv" aria-label="Download my CV as a PDF">
            <svg width="60" height="60" fill="#B4471A" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 43.916 43.916">
                <rect x="6" y="2" width="30" height="38" fill="#2563EB"/>
