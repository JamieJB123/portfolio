...
export default function CV() {
    return (
        <a href="public/CV.pdf" download className="download-cv glow-box" style={{'--glow-color': 'var(--orange)'}} aria-label="Download my CV as a PDF">
            <svg width="100" height="100" fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 43.916 43.916" xml:space="preserve">
